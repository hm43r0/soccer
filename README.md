# Soccer Management Dashboard Plugin

A comprehensive WordPress plugin for managing soccer teams, matches, and referee controls with a modern, isolated UI that won't interfere with your existing theme.

## Features

- **Team Management**: Create, edit, and delete teams with player rosters
- **Match Management**: Schedule and manage matches between teams
- **Referee Dashboard**: Specialized interface for referees to control matches
- **Theme Isolation**: Advanced styling system that prevents conflicts with existing themes
...
3. Use the shortcodes to display the dashboards
...
```css
/* All plugin styles are scoped to prevent theme conflicts */
